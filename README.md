...
![UI Preview](firmware/tools/preview_all.png)
...
|-------|---------|-----------|
| LILYGO T-Display-S3 | 1.9" 320x170 (parallel) | USB-C, 2 buttons, touch |
| Waveshare ESP32-S3-LCD-1.47 | 1.47" 320x172 (SPI) | USB-A, 1 button |
...
5. (Optional) Install the [Chrome extension](#chrome-extension) for one-click Claude.ai session key setup
