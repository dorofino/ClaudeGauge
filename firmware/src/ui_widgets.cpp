...
void UIWidgets::drawLcarsFrame(TFT_eSprite& spr, const char* title,
    ...
    // Second segment: peach pill-bar on the right with branding
    const int16_t seg2X = 210;
    // Rounded left cap — overflow past screen right clips to straight edge
    spr.fillRoundRect(seg2X, barY, SCR_W - seg2X + barH, barH, barH / 2, CLR_PEACH);
